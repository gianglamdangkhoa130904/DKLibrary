...
public class CategoryOfBookFragment extends Fragment {
    RecyclerView recyclerView;
    DBHelper dbHelper;
    CategoryBookAdapter categoryBookAdapter;
    ArrayList<BookModel> arrBook;
    public CategoryOfBookFragment(){
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_category_of_book, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        recyclerView = view.findViewById(R.id.rcv_listbook_category);
    ...
    public void onResume() {
        ...
        arrBook = new ArrayList<>();
        store_data();
        categoryBookAdapter = new CategoryBookAdapter(getActivity(),arrBook);
