...
import com.example.finalvalue.Admin.ListActivity.ListChapterActivity;
import com.example.finalvalue.Model.BookModel;
import com.example.finalvalue.R;

import java.util.ArrayList;

public class PageBookAdapter extends RecyclerView.Adapter<PageBookAdapter.MyViewHolder>{
    private Context context;
    private ArrayList<BookModel> arrBook;

    public PageBookAdapter(Context context, ArrayList<BookModel> arrBook) {
    ...
    @NonNull
    @Override
    public PageBookAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_list_book_for_category, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PageBookAdapter.MyViewHolder holder, int position) {
        ...
        holder.mainlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(holder.itemView.getContext(), ListChapterActivity.class);
                a.putExtra("book_id", arrBook.get(position).idBook);
